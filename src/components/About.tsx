        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-6/12">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              I'm Mohamed Silar, a B.Tech Information Technology student with a 8.00 CGPA (up to 6th semester) at Velammal College of Engineering & Technology. I'm passionate about developing applications that solve real-world problems and continuously expanding my knowledge in software development.
            </p>
